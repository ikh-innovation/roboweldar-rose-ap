...
If you'd like to contribute, start by searching through the [issues](https://github.com/ikh-innovation/roboweldar-rose-ap/issues) and
[pull requests](https://github.com/ikh-innovation/roboweldar-rose-ap/pulls) to see whether someone else has raised a similar idea or
question. 
...
[Issues](https://github.com/ikh-innovation/roboweldar-rose-ap/issues) and [Pull Requests](https://github.com/ikh-innovation/roboweldar-rose-ap/pulls)
...
```bash
git clone git@github.com:your-github-username/roboweldar-rose-ap.git
```

3.  Add the main roboweldar-rose-ap repository as a remote to your forked repository (use any name for your remote
    repository, it does not have to be roboweldar-rose-ap, although we will use it in the next steps):

```bash
git remote add roboweldar-rose-ap git@github.com:ikh-innovation/roboweldar-rose-ap.git
```
...
```bash
git fetch roboweldar-rose-ap
```

3.  Merge them:

```bash
git rebase roboweldar-rose-ap/master
```
